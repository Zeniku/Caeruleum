...
import caeruleum.entities.bullet.*;
import caeruleum.entities.abilities.*;
import caeruleum.ai.types.*;

public class CaeUnits{
	...
	public static void load(){
		...
		traho = new UnitType("traho"){{
			...
			weapons.add(
				new Weapon("caeruleum-trahoWeapon"){{
					x = 0;
					y = -5 / 4;
					recoil = 0;
					reload = 30;
				...
				new Weapon("caeruleum-trahoWeaponII"){{
					x = 3 / 4;
					y = 0;
					shootY = 25 / 4;
					reload = 30;
		...
		spiculum = new UnitType("spiculum"){{
			...
			constructor = UnitEntity::create;
			weapons.add(
				new Weapon("caeruleum-spiculumWeapon"){{
					x = 34 / 4;
					y = 0;
					reload = 15;
					rotate = false;
			...
			weapons.add(
				...
				new Weapon(){{
					...
					bullet = new ArtilleryBulletType(){{
						...
						speed = 3.7f;
						lifetime = 55;
						hitEffect = despawnEffect = CaeFx.bigBoom;
						height = 16;
						width = 16;
						damage = 230;
						splashDamage = 40;
		...
		eterius = new UnitType("eterius"){{
			...
			weapons.add(
				new Weapon("caeruleum-eteriusLaser"){{
					x = 0;
					y = -5 / 4;
					mirror = false;
					rotate = true;
					rotateSpeed = 1.5f;
					shoot.firstShotDelay = CaeFx.laserCharge.lifetime;
					recoil = 4;
		...
		princeps = new UnitType("princeps"){{
			...
			armor = 3;
			weapons.add(
				new Weapon("caeruleum-princepsWeapon"){{
					x = 5;
					y = 0;
					top = false;
					reload = 15;
		...
		procurator = new UnitType("procurator"){{
			...
			weapons.add(
				new Weapon("caeruleum-procuratorWeapon"){{
					x = 25 / 4;
					y = 3 / 4;
					top = false;
					reload = 25;
		...
		inductor = new UnitType("inductor"){{
			...
			weapons.add(
				new Weapon("caeruleum-inductorShotgun"){{
					x = 36 / 4;
					y = 1 / 4;
					reload = 60;
					top = false;
				...
				new Weapon("caeruleum-inductorArtillery"){{
					x = 0;
					y = -21 / 4;
					reload = 190;
					mirror = false;
		...
		lucius = new UnitType("lucius"){{
			...
			weapons.add(
				new Weapon("caeruleum-luciusWeapon"){{
					x = 44 / 4;
					y = 1 / 4;
					reload = 20;
					top = false;
					...
					rotate = true;
					rotateSpeed = 60;
					bullet = CaeBullets.luciusBullet;
				}},
				new Weapon("caeruleum-earthBend"){{
					x = 0;
					y = 0;
					reload = 120;
					mirror = false;
					...
					bullet = new GroundSummonBulletType(){{
					  shootEffect = Fx.none;
						speed = 2.5f;
						lifetime = 60;
						groundBullet = CaeBullets.standardSpike;
						groundEffect = CaeFx.earthDust;
						groundBullets = 6;
		...
		machaera = new UnitType("machaera"){{
			...
			weapons.add(
				new Weapon("caeruleum-machaeraWeapon"){{
					x = 75 / 4;
					y = -6 / 4;
					reload = 35;
					top = false;
					...
					bullet = CaeBullets.machaeraBullet;
					inaccuracy = 10;
				}},
				new Weapon("caeruleum-earthBendII"){{
					x = 0;
					y = 0;
					reload = 120;
					mirror = false;
					...
					bullet = new GroundSummonBulletType(){{
						...
						speed = 2.5f;
						lifetime = 60;
						groundBullet = CaeBullets.mediumSpike;
						groundEffect = CaeFx.earthDustII;
						groundBullets = 6;
